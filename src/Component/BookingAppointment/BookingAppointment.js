    ...
    return (
        <>
         ...
         <section className="container">
          <h2 className="text-center mb-5">Available Appointment on {date.toDateString()}</h2> 
          <div className="row">
          {
              bookingData.map(booking=><div className="col-md-4"><BookingCard booking={booking} date={date}></BookingCard></div>)
          }
          </div>   
         </section>   
        </>
